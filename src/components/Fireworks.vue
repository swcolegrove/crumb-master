...
export default {
  ...
  mounted() {
    ...
    EventBus.$on('fireworks:start', () => {
      console.log('fireworks starting'); // eslint-disable-line
      if (launchInterval) {
    ...
    EventBus.$on('fireworks:stop', () => {
      console.log('fireworks stopping'); // eslint-disable-line
      clearInterval(launchInterval);
      this.clearCanvas();
    });

    EventBus.$on('fireworks:faded', () => {
      console.log('fireworks done and faded'); // eslint-disable-line
      this.clearCanvas();
    });
